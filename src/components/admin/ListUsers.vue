<template>
    <div id="users">
        <b-notification v-if="errors.length" type="is-danger" aria-close-label="Close">
            ...
            >
                <div class="buttons">
                    <b-button
                        type="is-primary"
                        size="is-small"
                        @click="updateCode(props.row.objectId, props.row.clientCode, props.row.email)"
                    ...
                    <b-button
                        type="is-primary"
                        size="is-small"
                        @click="updateRole(props.row.objectId, props.row.role, props.row.email)"
